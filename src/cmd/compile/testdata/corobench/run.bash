...
benchmarks='^Benchmark(YieldBatch|YieldEntry|RecursiveYield64|RecursiveYield4096|MutualYield64|MutualYield4096|DeferYield|RecoverYield|TaskSequence|TaskBurst100|TaskPark100|ChannelRoundTrip|ReadySelect|SleepZero|SleepNanosecond|FileRead|TCPRead|FileBlockingProgress|TCPBlockingProgress|CScalar|CAggregate|CErrno|CLibm|CBlockingHandoff|CBlockingGroup3|CBlockingGroup8)$'
samples=${SAMPLES:-10}
