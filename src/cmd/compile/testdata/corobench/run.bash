...
benchmarks='^Benchmark(YieldBatch|YieldEntry|RecursiveYield64|RecursiveYield4096|RecursiveLargeFrame512|MutualYield64|MutualYield4096|DeferYield|RecoverYield|TaskSequence|TaskBurst100|TaskPark100|ChannelRoundTrip|ReadyChannelPair|ReadySelect|BlockedSelect|SleepZero|SleepNanosecond|FileRead|TCPRead|FileBlockingProgress|TCPBlockingProgress|CScalar|CAggregate|CErrno|CLibm|CBlockingHandoff|CBlockingGroup3|CBlockingGroup8)$'
samples=${SAMPLES:-10}
