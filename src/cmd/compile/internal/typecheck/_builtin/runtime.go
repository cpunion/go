...
func coroDeferRun(unsafe.Pointer, func(unsafe.Pointer) uint8)
func coroDeferGoexit(unsafe.Pointer)
...
func coroTakeFusedFrame(unsafe.Pointer, func(unsafe.Pointer) uint8, uintptr, *byte) unsafe.Pointer
